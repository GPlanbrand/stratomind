    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">4A公司标准 · 8维度专业分析框架</p>
          </div>
        </div>
      </div>
            ...
            <div key={competitor.id} className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="px-6 py-4 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <span className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 text-white text-sm font-bold flex items-center justify-center">
                    {index + 1}
                  </span>
      ...
      {showCharts && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-start justify-center p-4 overflow-y-auto">
          <div className="bg-gray-100 rounded-2xl w-full max-w-7xl my-8 overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <div className="sticky top-0 bg-white/95 backdrop-blur-sm border-b border-gray-200 px-8 py-5 flex items-center justify-between z-10">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">竞品对比分析报告</h2>
                <p className="text-sm text-gray-500">基于4A公司专业分析框架</p>
              </div>
              <button onClick={() => setShowCharts(false)} className="p-3 hover:bg-gray-100 rounded-xl transition-colors">
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="relative">
                <div className="absolute top-4 right-4 z-10">
                  <button onClick={() => exportChartAsImage('chart-comparison', '竞品对比总览')}
                    className="flex items-center gap-2 px-4 py-2 bg-white text-gray-700 text-sm rounded-lg hover:bg-gray-50 shadow-sm border border-gray-200">
                    <Download className="w-4 h-4" />导出PNG
                  </button>
                </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 rounded-2xl p-6 border border-blue-100">
                <h4 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                  <span className="w-8 h-8 rounded-full bg-blue-500 text-white text-sm flex items-center justify-center">📊</span>
                  4A竞品分析报告使用指南
                </h4>
                <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                  <div>
                    <h5 className="font-semibold text-gray-800 mb-2">对比总览表</h5>
                    <p>快速了解各竞品在核心维度的差异化表现，识别市场机会点</p>
                  </div>
                  <div>
                    <h5 className="font-semibold text-gray-800 mb-2">竞争力雷达图</h5>
                    <p>六维度综合实力对比，发现我方品牌与竞品的优劣势分布</p>
                  </div>
                  <div>
                    <h5 className="font-semibold text-gray-800 mb-2">SWOT分析</h5>
                    <p>深入理解竞品的战略态势，为我方定位提供参考依据</p>
                  </div>
                  <div>
                    <h5 className="font-semibold text-gray-800 mb-2">定位矩阵</h5>
                    <p>可视化展示各品牌在价格-品质坐标系中的位置</p>
                  </div>
                </div>
                <p className="mt-4 text-blue-600 font-medium flex items-center gap-2">
